<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __("Actualiza la información del Perfil y Correo Electronico.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="name" class="dark:text-white" :value="__('Name')" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="bg-puerto-rico-600 hover:bg-puerto-rico-500 dark:bg-puerto-rico-800 dark:text-white dark:border-puerto-rico-600 dark:hover:bg-puerto-rico-700">{{ __('Save') }}</x-primary-button>
